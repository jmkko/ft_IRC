...
void test_nick(Server& s, t_results* r)
{
    ...
    run_test(r, [&] { valid_nick2_should_void(s); }, "ro3ro should void himself");
    ...
    run_test(r, [&] { starting_with_number_should_err(s); }, "3oro should err");
    run_test(r, [&] { taken_should_err(s); }, "taken should err");
}
